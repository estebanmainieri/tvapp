...
type RouteType = RouteProp<RootStackParamList, 'Country'>;
...
export function CountryScreen() {
  ...
  const channels = useMemo(
    () => channelIndex?.byCountry.get(countryCode) ?? [],
    [channelIndex, countryCode],
  );
  ...
  if (isLoading) {
    return <LoadingSpinner message={`Loading ${countryName}...`} fullScreen />;
  }
